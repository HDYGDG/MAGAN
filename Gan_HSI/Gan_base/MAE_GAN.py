...
class netG(nn.Module):
    def __init__(self, nz, ngf, nc, img_size=224, patch_size=16, in_chans=30,
        ...
        self.Tanh = nn.Tanh()
        self.conv1 = nn.ConvTranspose2d(240, 256, kernel_size=3, stride=1, padding=0, bias=False)
        self.conv12 = nn.ConvTranspose2d(240, 256, kernel_size=4, stride=1, padding=0, bias=False)
        ...
        self.conv4 = nn.ConvTranspose2d(64, 32, 3, 1, 0, bias=False)
        # self.conv44 = nn.ConvTranspose2d(64, 32, 3, 2, 1, bias=False)
        # self.BatchNorm4 = nn.BatchNorm2d(32)

        self.conv5 = nn.ConvTranspose2d(64, 32, 3, 1, 0, bias=False)
    ...
    def forward(self, input, mask_ratio):
        ...
        latent1 = latent1.reshape(latent1.shape[0], 240, 5, 6)
        latent2 = latent2.reshape(latent2.shape[0], 240, 4, 5)
        #
        # latent1 = latent1.reshape(latent1.shape[0], 240, 5, 9)
        # latent2 = latent2.reshape(latent2.shape[0], 240, 1, 5)
